...
const SITE_URL = 'https://birthday-letter-experience.onrender.com';
  ...
  return (
    <div className="letter-stage">
      ...
      <div className="letter-frame">
        ...
        <img
          src={letterImage}
          alt="Handwritten birthday letter"
        />
...
function App() {
  ...
  return (
    ...
    >
      ...
      {step === 'home' && (
        <section className="hero page-in">
          ...
          <div className="hero-copy">
            ...
            <p className="subcopy">
              Today is yours. So I made you something you can
              open, keep, and come back to whenever you want
          ...
          <div className="hero-art">
            ...
            <div className="photo-stack">
              ...
              <div className="photo-main">
                ...
                <img
                  src={calendarImage}
                  alt="A tiny handmade calendar card"
                />
              ...
              <div className="doodle d1">
                ✦
              </div>

              <div className="doodle d2">
                ♥
              </div>

              <div className="doodle d3">
                ✧
              </div>
      ...
      {step === 'envelope' && (
        <section className="scene page-in">
      ...
      {step === 'calendar' && (
        <section className="scene page-in">
          ...
          <div className="scene-heading">
            ...
            <h2>
              Keep this <em>day</em> close
            </h2>

            <p>
              Tap the card when you're ready.
            </p>
      ...
      {step === 'letter' && (
        <section className="scene page-in letter-page">
          <Letter
        ...
        >
          ...
          >
            ...
            <div className="qr-box">
              <img
                src="/qr.png"
                alt="QR code for this birthday website"
              />
            </div>

            <p>
              Point your phone camera here and let the
              surprise begin.
            </p>
      ...
      <footer className="footer">
        made for one very special person
        <span>♥</span>
      </footer>
